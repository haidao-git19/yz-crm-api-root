 ...
 *
 */
public class ArchiveListRes extends AbstractBizBean{
	 ...
	 * 用药建议
	 */
	private List<DrugRes> drugBeans = new ArrayList<DrugRes>();


	public List<DrugRes> getDrugBeans() {
		return drugBeans;
	}

	public void setDrugBeans(List<DrugRes> drugBeans) {
