...
@ContextConfiguration(locations = {"classpath*:/yzcrm-daoConfig.xml","classpath*:dubbo-consumer.xml","classpath*:/spring-crm-bean.xml","classpath*:/spring-crm-service.xml"})
